import { FaFacebookSquare, FaRegBell } from "react-icons/fa"
...
const Profile = () => {
    ...
    return (
        <div className="max-w-[1090px] mx-auto my-10 px-4">
            <h1 className="text-center font-bold text-DMD my-5">Thông tin cá nhân</h1>
            ...
            <div className="grid grid-cols-12 gap-4">
                ...
                <div className="col-span-12 lg:col-span-9">
                    ...
                    <div className="rounded-xl text-TSM shadow mb-5">
                        <div className="p-5">
                            <h1 className="text-DXS font-medium">Mật khẩu</h1>
                    ...
                    <div className="rounded-xl text-TSM shadow">
                        <div className="p-5">
                            <h1 className="text-DXS font-medium mb-3">Mạng xã hội</h1>
                            ...
                            <div className="max-w-[678px] mt-3">
                                ...
                                <div>
                                    ...
                                    <div className="md:flex justify-between gap-10 p-5 border rounded-xl my-5">
                                        ...
                                        <Button className="px-10 bg-white border-red-500 text-red-500 rounded-xl hover:text-white h-9 ">Xóa </Button>
                                    </div>
                                </div>
